...
Full captures: [desktop](mockups/identity/border-kit-desktop.png) (2880×19000) · [phone](mockups/identity/border-kit-phone.png) (780×32278) · [HTML source](mockups/identity/border-kit.html) · [tile authoring spec](border-kit-tile-spec.md) (superseded in part — [`identity-direction.md`](identity-direction.md) governs where they disagree)
